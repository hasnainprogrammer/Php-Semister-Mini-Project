...
@media (max-width:450px) {
 ...
 <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
  <div class="mb-3 inner-container">
    ...
    <button type="submit" name="searchbtn" class="btn btn-dark">Search</button>
  </div>
 </form>
<table class="table">
  <thead>
    ...
    if($num_rows > 0){
      while($row = mysqli_fetch_assoc($result)){
        ...
        echo "<tr>
          ...
          <td>$payment</td>
          <td>$date</td>
          <td><a href='update.php?sno=$sno' class='btn btn-sm btn-dark'>Update</a>&nbsp;&nbsp;&nbsp;<a class='btn btn-sm btn-dark' onclick='delete_confirm($sno)'>Delete</a></td>
      </tr>";
      }
    }else{
...
<h2 class='text-center my-4 text-light bg-dark'><?php echo $no_rows; ?></h2>
</div>
